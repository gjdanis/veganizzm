"""
Django settings for veganizzm project. Generated by `django-admin startproject` using Django 1.9.4.
...
SECRET_KEY = '5rjts+-(6d75u2ar%&x+=3&h-me2-&&-x&tbnzvxcjcg)tqilp'
...
WSGI_APPLICATION = 'veganizzm.wsgi.application'
